		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Gestión de Resúmenes de cuenta YER",
									"targetURL": "#ypfzz1com741lm4free2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ypfzz1com741lm4free2-display": {
								"semanticObject": "ypfzz1com741lm4free2",
								"action": "display",
								"description": "Gestión de Resúmenes de cuenta YER",
								"title": "Gestión de Resúmenes de cuenta YER",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ypf.zz1com741lm4free2",
									"url": sap.ui.require.toUrl("ypf/zz1com741lm4free2")
								}
							}
						}
					}
